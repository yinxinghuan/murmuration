...
- 游戏：Murmuration
- 类型：casual
- 简述：Drag to gather the flock — your finger is the attractor; birds, fireflies or seeds chase it, swirl into shape, then scatter when you release. Dusk starlings, forest fireflies, spring meadow seeds.
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Murmuration；cover_url=/poster.png；category=casual；uuid=80a9c76c-12d0-46cd-be04-b3368cb05319
